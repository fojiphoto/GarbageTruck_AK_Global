...
//		YZ // do not use
	...
	public class minimap_gui_settings
	{
		...
		public float itsScaleIcons=2.08f;
...
//		Debug.Log("Rot:"+itsRotation);
	...
	{
		bool check = false;
		Debug.Log ("------>>>>Full screen Active:");
		Debug.Log (" Full screen mode: " + theFullscreenMode);
...
//		KGFGUIUtility.EndHorizontalBox();
	...
	public override KGFMessageList Validate()
	{
		...
		RegionError(ref aMessageList,"itsAppearanceMiniMap.itsScaleIcons",itsDataModuleMinimap.itsAppearanceMiniMap.itsScaleIcons,0,2f);
		...
		RegionError(ref aMessageList,"itsAppearanceMap.itsScaleIcons",itsDataModuleMinimap.itsAppearanceMap.itsScaleIcons,0,2.08f);
